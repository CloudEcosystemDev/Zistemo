/**
 * Auto-generated trigger file for "Zistemo API specs." API.
 * Generated at: 2022-06-27T09:47:57.853Z
...
function processTrigger(msg, cfg, snapshot, incomingMessageHeaders, tokenData) {
  ...
  let securities = {};
    ...
    securities['api_dev_key'] = cfg['key'];
    securities['x_api_dev_key'] = cfg['key'];
    securities['token'] = cfg['key'];
